...
namespace BUT
{
    ...
    public class PlayerMovement : MonoBehaviour
    {
        ...
        public void SetInputDash(InputAction.CallbackContext _context)
        {
            if (_context.started && canDash)
            {
        ...
        private IEnumerator DashForward()
        {
            ...
            while (Time.time < startTime + m_Movement.DashDuration)
            {
                m_CharacterController.Move(dashDirection * m_Movement.DashForce * Time.deltaTime);
                yield return null;
            }
            ...
            yield return new WaitForSeconds(m_Movement.DashCooldown);
            canDash = true;
        }
